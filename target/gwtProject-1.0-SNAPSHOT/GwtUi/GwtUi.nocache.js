function GwtUi(){
  ...
  GwtUi.__sendStats = sendStats;
  GwtUi.__moduleName = $intern_4;
  GwtUi.__errFn = null;
  GwtUi.__moduleBase = $intern_6;
  GwtUi.__softPermutationId = $intern_7;
  GwtUi.__computePropValue = null;
  GwtUi.__getPropMap = null;
  GwtUi.__installRunAsyncCode = function(){
  }
  ;
  GwtUi.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  GwtUi.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  GwtUi.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  GwtUi.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[GwtUi.__softPermutationId];
    ...
    function installCode(code_0){
      ...
      if (GwtUi.__errFn) {
        script.onerror = function(){
          GwtUi.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  GwtUi.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  GwtUi.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function computeUrlForResource(resource){
    ...
    return GwtUi.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    GwtUi.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = GwtUi.__getPropMap;
    ...
    GwtUi.__softPermutationId = softPermutationId;
  ...
  processMetas();
  GwtUi.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = GwtUi.__moduleBase;
